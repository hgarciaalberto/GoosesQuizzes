...
//    private lateinit var mainViewModel: EventListViewModel
...
//        mainViewModel = ViewModelProviders.of(this, viewModelFactory).get(EventListViewModel::class.java)
//
